    ...
    <div class="col-md-12">
        <div class="box">
            <div class="box-header">
                <h3 class="box-title"> {{trans('company.other_details')}} </h3>
            </div><!-- /.box-header -->
            <div class="box-body">
                <div class="box-tools">
                    <div class="row">
                        ...
                        <div class="nav-tabs-custom">
                            <ul class="nav nav-tabs">
                                <li class="active"><a href="#address_data_t" data-toggle="tab">{{trans('company.address')}}</a></li>
                                <li><a href="#person_data_t" data-toggle="tab">{{trans('company.person')}}</a></li>
                            </ul>
                        </div><!-- nav-tabs-custom -->
                        </div>
                    </div>
...
<script type="text/template" id="commu_tab_template1">
    <tr data-id='new'>
        ...
        <td>
            <a class="btn btn-info save_other_add" data-id="new" > {{trans('common.save')}}</a>
        </td>
    </tr>
</script>
<script type="text/template" id="commu_tab_template2">
    <tr data-id='new'>
        ...
        <td>
            <a class="btn btn-info save_person" data-id="new" > {{trans('common.save')}}</a>
        </td>
    </tr>
</script>
...
<script type="text/template" id="commu_tab_template3">
    <tr data-id='new'>
        ...
        <td>
            <a class="btn btn-info save_person_commu" data-id="new" > {{trans('common.save')}}</a>
        </td>
    </tr>
</script>
@stop
